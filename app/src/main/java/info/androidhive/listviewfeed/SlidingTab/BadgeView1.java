 ...
 * @author Jeff Gilfelt
 */
public class BadgeView1 extends TextView {
	...
	public BadgeView1(Context context, AttributeSet attrs) {
		 this(context, attrs, android.R.attr.textViewStyle);
	}

    public BadgeView1(Context context, SlidingTabStrip target,
                      int i) {
     ...
     */
	public BadgeView1(Context context, View target) {
     ...
     */
	public BadgeView1(Context context, SlidingTabLayout target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}


	public BadgeView1(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}

	public BadgeView1(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
