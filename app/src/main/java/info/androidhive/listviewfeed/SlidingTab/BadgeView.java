...
public class BadgeView extends TextView {
    ...
    public BadgeView(Context context, info.androidhive.listviewfeed.SlidingTab.SlidingTabStrip  target,
                      int i) {
     ...
     */
	public BadgeView(Context context, SlidingTabLayout target, int index) {
